...
#if NEXTMU_OPERATING_SYSTEM == NEXTMU_OS_WINDOWS
#define NEXTMU_D3D11_SUPPORTED			(1)
#define NEXTMU_D3D12_SUPPORTED			(1)
#define NEXTMU_GL_SUPPORTED			    (1)
#define NEXTMU_GLES_SUPPORTED			(0)
#define NEXTMU_VULKAN_SUPPORTED		    (1)
#define NEXTMU_METAL_SUPPORTED			(0)
#elif NEXTMU_OPERATING_SYSTEM == NEXTMU_OS_ANDROID || NEXTMU_OPERATING_SYSTEM == NEXTMU_OS_LINUX
#define NEXTMU_D3D11_SUPPORTED			(0)
