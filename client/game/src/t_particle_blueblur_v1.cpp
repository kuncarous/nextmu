...
constexpr auto Type = ParticleType::BlueBlur_V1;
constexpr auto LifeTime = 30;
static const mu_char* ParticleID = "blueblur_v1";
static const mu_char *TextureID = "poundingball";
...
static TParticleBlueBlurV1 Instance;
static NGraphicsTexture* texture = nullptr;

TParticleBlueBlurV1::TParticleBlueBlurV1()
{
...
void TParticleBlueBlurV1::Initialize()
{
	texture = MUResourcesManager::GetResourcesManager()->GetTexture(TextureID);
}

void TParticleBlueBlurV1::Create(entt::registry &registry, const NParticleData &data)
{
	using namespace TParticle;
...
EnttIterator TParticleBlueBlurV1::Move(EnttRegistry &registry, EnttView &view, EnttIterator iter, EnttIterator last)
{
	using namespace TParticle;
...
EnttIterator TParticleBlueBlurV1::Action(EnttRegistry &registry, EnttView &view, EnttIterator iter, EnttIterator last)
{
	using namespace TParticle;
...
EnttIterator TParticleBlueBlurV1::Render(EnttRegistry &registry, EnttView &view, EnttIterator iter, EnttIterator last, NRenderBuffer &renderBuffer)
{
	using namespace TParticle;
...
void TParticleBlueBlurV1::RenderGroup(const NRenderGroup &renderGroup, NRenderBuffer &renderBuffer)
{
